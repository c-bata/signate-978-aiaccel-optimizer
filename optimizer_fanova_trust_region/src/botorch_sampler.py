...
* Increase num_restarts while optimizing acq functions (default: 10).
...
class BoTorchSampler(BaseSampler):
    def __init__(
        ...
        *,
        ...
        min_n_trials_trust_region: int = 5,
    ):
        ...
        self._min_n_trials_trust_region: int = min_n_trials_trust_region
    ...
    def get_trials_and_search_space(
        self,
        study: Study,
        search_space: dict[str, BaseDistribution]
    ) -> tuple[list[FrozenTrial], dict[str, BaseDistribution]]:
        ...
        if len(filtered_trials) < self._min_n_trials_trust_region:
            return trials, search_space
        else:
            return filtered_trials, self._trust_region
    ...
    def sample_relative(
        ...
        trials, search_space = self.get_trials_and_search_space(study, search_space)
        n_trials = len(trials)
        ...
        suggestion = trans.untransform(candidates.cpu().numpy())
        return suggestion
